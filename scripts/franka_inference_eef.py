...
def model_inference(args, config, ros_operator):
    ...
    def goto_homepose_2step():

        # Initial position of the franka arm
        right1 = np.array([0.381,  0.273,  0.584, -0.949,  0.078, -0.162, -0.257, 206])
        right2 = np.array([ 4.87415257e-01,  1.33694195e-01,  5.55746489e-01, -9.63823436e-01, 5.90333134e-02,  8.12245637e-04, -2.59920742e-01,206]) # mango peel
        # 
        # right1 = np.array([0.479,  0.084,  0.565, -0.573,  0.668, -0.356, -0.313, 100]) #cup
        # right2 = np.array([0.33453325,  0.45457331,  0.47811615, -0.77818588,  0.49373628, -0.32791843, -0.20765532,40])

        input("Press enter to initial position...")
        ros_operator.arm_publish(right1)

        input("Press enter to continue to initial position...")
        ros_operator.arm_publish(right2)
